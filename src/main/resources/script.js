document.addEventListener('DOMContentLoaded', function() {
    ...
    const downloadSessionsButton = document.getElementById('download-sessions-button');
...
function showAllSessions() {
    ...
    // Обработчик события click для кнопки "Скачать документ"
    downloadSessionsButton.addEventListener('click', downloadSessions);
});
